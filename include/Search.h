...
class Search{
	private:
		...
		int _costeSol;
	public:
		Search(int id, int ** m, int posRX, int posRY, int posIX, int posIY, int tamX, int tamY, int ratioX, int ratioY, tiposEstrategias es, int col, int posFX, int posFY);
		void init();
		...
		vector<State*> getSolucion() const;
		int getNelem() const;
